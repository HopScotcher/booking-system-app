...
async function main() {
  ...
  const business = await prisma.business.create({
    data: {
      ...
      description:
        "Professional home cleaning services for residential and commercial properties",
  ...
  const services = await Promise.all([
    ...
    prisma.service.create({
      data: {
        name: "Deep Cleaning",
        description:
          "Intensive cleaning including hard-to-reach areas, inside appliances, and detailed attention",
        price: 200.0,
    ...
    prisma.service.create({
      data: {
        ...
        description:
          "Comprehensive cleaning for properties being vacated or newly occupied",
        price: 250.0,
    ...
    prisma.service.create({
      data: {
        ...
        description:
          "Detailed kitchen cleaning including inside cabinets, appliances, and surfaces",
        price: 80.0,
    ...
    prisma.service.create({
      data: {
        ...
        description:
          "Thorough bathroom cleaning including grout, fixtures, and all surfaces",
        price: 60.0,
